...
IMAGE_FILE_NAME = "images/robot_image.jpeg"
b64 = ""
try:
...
with col1:
    if st.button("Agno RAG Agent", key="btn_agno", use_container_width=True, help="Use the RAG Agent for UPM Document Q&A."):
        ...
        st.switch_page("pages/1_Agno_RAG_Agent.py")
        

with col2:
    if st.button("CrewAI Multi-Agent", key="btn_crewai", use_container_width=True, help="Simulate a multi-agent team with CrewAI."):
        # Navigate using the page file name (without extension)
